#!/usr/bin/env node
/**
 * Record ace340fe continuation-crawl deploy provenance when current main (64a107df)
...
const LABEL =
  ...
  "ace340fe continuation crawl — NOT current-main 64a107df certification.";
...
const payload = {
  ...
  fail493EvidencePreserved: {
    ...
    repairPr: "497",
    note: "fa3b879 is newer #497 preview head — separate from preserved 9715c20d repair proof; NOT current-main cert while #497 open",
  },

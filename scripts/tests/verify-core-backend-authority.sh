...
git -C "$root" add .github/workflows/core-backend-authority.yml .github/workflows/secret-exposure-guard.yml scripts/check-core-backend-authority.sh scripts/check-tracked-secret-exposure.sh scripts/tests/verify-core-backend-authority.sh

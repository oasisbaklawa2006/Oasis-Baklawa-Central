-- Normalize starter_packs.items.quantity to represent KILOGRAMS (not packs).
-- Modal & cart code converts kg → packs at insert time using product net_weight_grams.

UPDATE public.starter_packs SET items = '[

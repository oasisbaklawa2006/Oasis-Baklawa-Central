...
type CustomerAppFunctions = {
  ...
  published_products_v1: { Args: never; Returns: { product_id: string; sku: string; product_name: string; short_description: string | null; long_description: string | null; category: string | null; subcategory: string | null; hero_image_url: string | null; pack_size: string | null; storage_type: string | null; shelf_life: string | null; shelf_life_days: number | null; dietary_tags: string[] | null; allergen_warnings: string | null; primary_uom: string | null; created_at: string }[] }
  ...
  customer_product_favourites_v1: { Args: never; Returns: { product_id: string; created_at: string }[] }
  set_customer_product_favourite_v1: { Args: { p_product_id: string; p_is_favourite: boolean }; Returns: { product_id: string; is_favourite: boolean }[] }
  customer_general_queries_v1: { Args: never; Returns: { query_id: string; category: string; subject: string; message: string; status: string; created_at: string; updated_at: string }[] }
  submit_customer_general_query_v1: { Args: { p_idempotency_key: string; p_subject: string; p_message: string; p_category?: string }; Returns: { query_id: string; status: string; is_duplicate_submission: boolean }[] }

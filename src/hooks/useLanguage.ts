...
const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  "Packed Ready": { en: "Packed Ready", hi: "पैक तैयार" },
  "Awaiting Final Payment": { en: "Awaiting Final Payment", hi: "अंतिम भुगतान प्रतीक्षा" },
  "Cleared for Dispatch": { en: "Cleared for Dispatch", hi: "डिस्पैच के लिए मंजूरी" },

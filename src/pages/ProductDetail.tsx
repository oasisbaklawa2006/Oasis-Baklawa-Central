  ...
  return (
    <AppShell>
      <div className="relative">
        <div className="max-w-md mx-auto bg-slate-50 min-h-screen pb-32 shadow-sm border-x border-slate-200">
              ...
              <div className="flex justify-between items-end">
                <div>
                  <p className="text-xs text-slate-400 line-through mb-0.5">
                    Standard: {formatPrice(baseWholesalePrice)} /pack
                  </p>
          ...
          <div className="bg-white mb-2">
            <div className="grid grid-cols-2 border-b border-slate-100">
              <div className="p-3 text-sm font-medium text-slate-500 border-r border-slate-100">Wt Per Pc.</div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    disabled={isAdding}
                    className="flex-1 h-14 rounded-xl bg-[#B8860B] text-white font-bold text-base shadow-xl flex items-center justify-center gap-2 active:scale-95 hover:bg-[#9A7009] transition-colors"
                  >
                    {isAdding ? <Loader2 size={20} className="animate-spin" /> : <ShoppingCart size={20} />} Add to
                    Order
                  </button>
                </div>
              </div>

        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl border border-border bg-card text-foreground font-bold text-sm flex items-center justify-center gap-2 hover:bg-muted transition-colors"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C4.24 16.7 4.88 10.41 8.68 10.2c1.19.06 2.02.7 2.72.73.99-.2 1.94-.77 3-.67 1.28.13 2.24.65 2.87 1.57-2.63 1.58-2.01 5.03.37 6.01-.46 1.17-1.05 2.33-1.59 3.44zM12.03 10.12c-.14-2.33 1.87-4.38 4.06-4.53.28 2.57-2.34 4.5-4.06 4.53z"/></svg>
              Apple
            </button>
          </div>
        </div>

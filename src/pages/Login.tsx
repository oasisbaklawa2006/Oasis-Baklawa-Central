          ...
          {activeTab === "msg91" && (
            <div className="space-y-4">
              ...
              >
                ...
                {!isMsg91Ready ? "Loading secure widget..." : loading ? "Launching widget..." : "Verify with MSG91"}
              </button>
            </div>
          )}
            ...
            <button
              onClick={async () => {
                ...
                logAuthEvent("GOOGLE_LOGIN_STARTED", {
                  attemptId, method: "google_oauth", identifier: null, result: "started",
                });
                ...
                if (error) {
                  logAuthEvent("GOOGLE_LOGIN_FAILED", {
                    attemptId, method: "google_oauth", identifier: null, result: "failed", error: error.message,
                  });
                  toast.error(error.message);
                }
              }}
              disabled={loading || isMinting}
              className="flex-1 py-3 rounded-xl border border-border bg-card text-foreground font-bold text-sm flex items-center justify-center gap-2 hover:bg-muted transition-colors disabled:opacity-60"
            >

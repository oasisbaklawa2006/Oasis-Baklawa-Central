...
export const APPVERSE_TV_SURFACES: AppVerseTvSurface[] = [
  ...
  { key: "chocolate", label: "Chocolate Line", route: "/tv/chocolate", audience: ["HOD_CHOCOLATE", "PROD_CHOCOLATE"], purpose: "Production line visibility" },
  { key: "dragees", label: "Dragees Line", route: "/tv/dragees", audience: ["HOD_DRAGEES", "PROD_DRAGEES"], purpose: "Production line visibility" },
  { key: "fusion", label: "Fusion Sweets Line", route: "/tv/fusion", audience: ["HOD_FUSION", "PROD_FUSION"], purpose: "Production line visibility" },
  ...
  { key: "ready-goods", label: "Ready Goods TV", route: "/admin/rgs-tv", audience: ["STORE_READY_GOODS", "RGS_ADMIN", "TV_READY"], purpose: "Ready-goods visibility" },

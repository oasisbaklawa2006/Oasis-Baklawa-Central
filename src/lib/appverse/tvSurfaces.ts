...
export const APPVERSE_TV_SURFACES: AppVerseTvSurface[] = [
  ...
  { key: "dispatch", label: "Dispatch TV", route: "/admin/dispatch-tv", audience: ["OPERATIONS_MANAGER", "TV_DISPLAY"], purpose: "Dispatch readiness and movement visibility (commercial fields — not for Dispatch workflow roles)" },
];

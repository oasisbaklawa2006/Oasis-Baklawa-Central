...
// Dragees has no standalone TV -- it shares the Chocolates & Confectionery
// screen, and Ready Goods runs on its own chrome-free kiosk route rather
// than the full authenticated /admin shell, per the owner's six-TV estate
// (Central issue #368).

...
export const CENTRAL_ADMIN_MODULE_AUTHORITY_MATRIX: CentralModuleAuthorityEntry[] = [
  ...
  { route: "/sales/clients/:companyId", label: "Sales Customer 360", surface: "SALES_CONSOLE", owner: "Central / CRM", routeGuardModuleKey: null, disposition: "CANONICAL", guard: "ROLE_PROTECTED", readAuthority: "SUPABASE", writeAuthority: "NONE", programmeOwnership: "POINT59", notes: "Account-manager fail-closed Customer 360 for sales executives." },
  ...
  { route: "/admin/management-command-center", label: "Management command center", surface: "CENTRAL_ADMIN", owner: "Central / Management Reporting", routeGuardModuleKey: "management_reporting", adminModuleRouteKey: "management_reporting", disposition: "CANONICAL", guard: "COMPOSITE", readAuthority: "MIXED", writeAuthority: "NONE", programmeOwnership: "POINT57", notes: "MACRO-MGMT #554 — governed operational/finance/collections/Tally/EAN/compliance reporting. Core #255 read-only bindings." },
  { route: "/admin/execution-command-center", label: "Execution command center", surface: "CENTRAL_ADMIN", owner: "Central / CMD War Room", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58", notes: "Reads operational_queue_items (dead data)." },
  { route: "/admin/execution-risk", label: "Execution risk board", surface: "CENTRAL_ADMIN", owner: "Central / CMD War Room", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  { route: "/admin/execution-bottlenecks", label: "Execution bottlenecks", surface: "CENTRAL_ADMIN", owner: "Central / CMD War Room", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  ...
  { route: "/admin/queue-execution-preview", label: "Queue execution preview", surface: "CENTRAL_ADMIN", owner: "Central / CMD War Room", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  { route: "/admin/barcode-execution-preview", label: "Barcode execution preview", surface: "CENTRAL_ADMIN", owner: "Central / CMD War Room", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  { route: "/admin/product-intelligence-prototype", label: "Product intelligence lab", surface: "CENTRAL_ADMIN", owner: "AI Studio (link-out)", routeGuardModuleKey: "cmd_war_room", adminModuleRouteKey: "cmd_war_room", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58", notes: "LINK-OUT to AI Studio authority." },
  ...
  { route: "/admin/execution/retail", label: "Retail execution board", surface: "CENTRAL_ADMIN", owner: "Central / Retail", routeGuardModuleKey: "inventory", adminModuleRouteKey: "inventory", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  { route: "/admin/execution/complaints", label: "Complaints execution board", surface: "CENTRAL_ADMIN", owner: "Central / Support", routeGuardModuleKey: "support", adminModuleRouteKey: "support", disposition: "QUARANTINED", guard: "COMPOSITE", readAuthority: "LOCAL", writeAuthority: "NONE", programmeOwnership: "POINT58" },

  // ── Customers / WhatsApp / Support ─────────────────────────────────────
  { route: "/admin/clients/:companyId", label: "Customer 360", surface: "CENTRAL_ADMIN", owner: "Central / CRM", routeGuardModuleKey: "clients", disposition: "CANONICAL", guard: "ADMIN_ROUTE_GUARD", readAuthority: "SUPABASE", writeAuthority: "NONE", programmeOwnership: "POINT59", notes: "Canonical operational Customer 360 read model bound to companies.id." },
  ...
  { route: "/admin/central-pool", label: "Central Order Pool", surface: "CENTRAL_ADMIN", owner: "Central / Orders", routeGuardModuleKey: "orders", adminModuleRouteKey: "orders", disposition: "CANONICAL", guard: "ADMIN_ROUTE_GUARD", readAuthority: "SUPABASE", writeAuthority: "RPC", programmeOwnership: "POINT71", notes: "Governed order pool command centre (Point71/74)." },
  { route: "/admin/cmd-war-room", label: "CMD war room (redirect)", surface: "CENTRAL_ADMIN", owner: "Central / Command", routeGuardModuleKey: "cmd_war_room", disposition: "COMPATIBILITY_ALIAS", guard: "ADMIN_ROUTE_GUARD", readAuthority: "NONE", writeAuthority: "NONE", programmeOwnership: "POINT71", notes: "Redirects to /admin/central-pool." },
  ...
  { route: "/admin/inventory-command-center", label: "Inventory command center", surface: "CENTRAL_ADMIN", owner: "Central / Inventory", routeGuardModuleKey: "inventory", disposition: "QUARANTINED", guard: "ADMIN_ROUTE_GUARD", readAuthority: "MIXED", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  ...
  { route: "/admin/inventory-risk-board", label: "Inventory risk board", surface: "CENTRAL_ADMIN", owner: "Central / Inventory", routeGuardModuleKey: "inventory", disposition: "QUARANTINED", guard: "ADMIN_ROUTE_GUARD", readAuthority: "MIXED", writeAuthority: "NONE", programmeOwnership: "POINT58" },
  ...
  { route: "/admin/verification", label: "Verification (redirect)", surface: "CENTRAL_ADMIN", owner: "Central / Command", routeGuardModuleKey: "cmd_war_room", disposition: "QUARANTINED", guard: "ADMIN_ROUTE_GUARD", readAuthority: "NONE", writeAuthority: "NONE", programmeOwnership: "POINT58", notes: "Redirects to execution-command-center." },
];

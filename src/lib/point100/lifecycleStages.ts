...
export const POINT100_LIFECYCLE_STAGES: readonly Point100LifecycleStage[] = [
  ...
  },
  {
    ...
    centralBindings: ["DispatchManagement", "AssemblyManagement"],
    fixtureEnvKeys: ["FACTORY_CERT_GOLDEN_ORDER_ID"],
  ...
  },
  {
    ...
    centralBindings: ["financeExitAuthorityClient", "DispatchFinalizationBoard"],
  ...
  },
  {
    ...
    centralBindings: ["financeExitAuthorityClient", "DispatchReadinessBoard"],
    fixtureEnvKeys: ["FACTORY_CERT_POINT38_ORDER_ID"],
  ...
  },
  {
    ...
    centralBindings: ["DispatchManagement", "GoldenChainOperatorWizard"],
    fixtureEnvKeys: ["FACTORY_CERT_POINT38_ORDER_ID"],

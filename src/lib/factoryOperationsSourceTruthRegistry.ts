...
export const FACTORY_SOURCE_TRUTH: FactorySourceTruthEntry[] = [
  ...
  },
  {
    ...
    status: "REFERENCE",
    readConsumers: ["ScanTimeline"],
    writeAuthority: "Legacy dispatch/carton lifecycle — superseded by b2b_dispatch_cartons for B2B order universe",
    evidence: "Legacy carton identity for gate/trace reads where not yet migrated. FACT-C3: DispatchManagement no longer writes this table — see b2b_dispatch_cartons below for the governed carton chain.",
  },
  {
    relation: "b2b_dispatch_cartons",
    subsystem: "DISPATCH",
    status: "AUTHORITATIVE",
    readConsumers: ["DispatchManagement", "CartonExplorer"],

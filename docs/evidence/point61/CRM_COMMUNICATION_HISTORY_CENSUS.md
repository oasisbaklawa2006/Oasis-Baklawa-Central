...
| **Point61 PR** | `#507` — Point61-only rebuild (**4 commits** above base; 3 substantive: feature + Gate-4 remedial + Gate-4 final review repair; 1 docs alignment); head `cfab4a14` |

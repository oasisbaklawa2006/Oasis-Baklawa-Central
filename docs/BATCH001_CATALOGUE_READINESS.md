...
| Near-ready (aliases + resolver OK; only media/visibility gap) | 15 / 25 |
...
| 6 | Product URL | Deep link `https://b2b.oasisbaklawa.com/product/{uuid}` resolves to product |
...
| SKU | Wave 2C status |
|-----|----------------|
| OAS-AS-BKL-0002 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0004 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0005 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0006 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0008 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0009 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0011 | Pending (32 SAFE_TO_APPROVE terms in pack) |
| OAS-AS-BKL-0018 | Pending (32 SAFE_TO_APPROVE terms in pack) |
